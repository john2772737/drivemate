        ...
        <div className="grid md:grid-cols-2 items-center gap-4 max-md:gap-8 max-w-6xl max-md:max-w-lg w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
          <div className="md:max-w-md w-full px-4 py-4">
            <form onSubmit={handleSubmit}>
              <div className="mb-12">
                <h3 className="text-gray-800 text-3xl font-extrabold">Login</h3> {/* Changed "Sign in" to "Login" */}
              </div>

              <div>
                <label className="text-gray-800 text-xs block mb-2">Username</label> {/* Changed Email to Username */}
              ...
              <div className="mt-12">
                <button type="submit" className="w-full shadow-xl py-2.5 px-4 text-sm tracking-wide rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                  Login
                </button> {/* Changed "Sign in" to "Login" */}
              </div>
            </form>
          </div>
